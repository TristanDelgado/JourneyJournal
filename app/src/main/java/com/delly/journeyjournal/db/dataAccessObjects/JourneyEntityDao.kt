...
interface JourneyEntityDao {
     ...
     */
    @Query("SELECT * FROM journeyEntities ORDER BY journalName ASC")
     ...
     */
    @Query("SELECT * FROM journeyEntities WHERE journalName = :journalName")
     ...
     */
    @Query("SELECT * FROM journeyEntities WHERE journalName LIKE :searchQuery")
     ...
     */
    @Query("DELETE FROM journeyEntities WHERE journalName = :journalName")
    suspend fun deleteJournalByName(journalName: String)

    /**
     * Deletes all journal entries from the database.
     */
    @Query("DELETE FROM journeyEntities")
